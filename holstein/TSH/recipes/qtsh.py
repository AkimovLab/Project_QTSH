...
def load(dyn_general):
    ...
    dyn_general.update( {"force_method":3, "rep_force":1} ) # QTSH with adiabatic rep
    ...
    #dyn_general.update({"hop_acceptance_algo":20, "momenta_rescaling_algo":0 })  # accept based on NAC vectors, no rescaling
    dyn_general.update({"hop_acceptance_algo":0, "momenta_rescaling_algo":0 })  # accept all, no rescaling
